			...
			rules: [{
					...
					use: {
						...
						options: {
							...
							plugins: [path.join(__dirname, '../node_modules/@babel/plugin-transform-runtime/lib/index.js')]
						}
					}
				},
				{
				...
				},
				{
					test: /\.css$/,
					use: [
						path.join(__dirname, '../node_modules/style-loader/index.js'),
						{
				...
				},
				{
					...
					use: [
						...
						path.join(__dirname, '../node_modules/sass-loader/lib/loader.js'),
						{
							loader: path.join(__dirname, '../node_modules/postcss-loader/src/index.js'),
							options: {
								ident: 'postcss',
